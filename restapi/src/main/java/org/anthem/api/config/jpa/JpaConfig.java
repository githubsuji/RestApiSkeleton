package org.anthem.api.config.jpa;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"org.anthem.api.repository","org.calibroz.api.resources"}, entityManagerFactoryRef = "entityManagerFactory",
        transactionManagerRef = "transactionManager")
@EnableTransactionManagement
@PropertySource("classpath:jpa/jpa.properties")
public class JpaConfig {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
   ...
   em.setPackagesToScan("org.anthem.api.jpa.entities","org.anthem.api.jpa.resource.entities");
